//
//  SelectMainCartaDetailNegativeRequestViewController.swift
//  CounselingMaster
//
...
class SelectMainCartaDetailNegativeRequestViewController: UIViewController, FusumaDelegate{
    ...
    @IBAction func upDateImage(_ sender: Any) {
        var detailNegativeRequestImage1Data = firstImageView.image?.pngData()
        var detailNegativeRequestImage2Data = secondImageView.image?.pngData()
